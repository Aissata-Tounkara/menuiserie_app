...
import { Search, Plus, Edit2, Trash2, AlertTriangle, TrendingDown, TrendingUp, Package, Box, Layers, Filter, Download, RefreshCw } from 'lucide-react';
...
export default function GestionStock() {
  ...
  const articles = [
    ...
    },
    {
      id: 6,
      nom: 'Joint EPDM noir',
      reference: 'JOI-EPD-001',
      categorie: 'Joints et étanchéité',
      quantite: 185,
      unite: 'mètre linéaire',
      seuilAlerte: 100,
      prixAchat: 120,
      fournisseur: 'Etanchéité Pro',
      emplacement: 'Zone C - Étagère 5',
      derniereEntree: '04/11/2024',
      derniereSortie: '10/11/2024'
    },
    {
      id: 7,
      nom: 'Mastic silicone transparent',
      reference: 'JOI-MAS-002',
      categorie: 'Joints et étanchéité',
      quantite: 6,
      unite: 'cartouche',
      seuilAlerte: 12,
      ...
      fournisseur: 'Etanchéité Pro',
      emplacement: 'Zone C - Étagère 5',
      derniereEntree: '02/11/2024',
      derniereSortie: '09/11/2024'
    },
    {
      id: 8,
      nom: 'Moteur volet roulant',
      reference: 'ACC-MOT-001',
      categorie: 'Accessoires',
      quantite: 12,
      unite: 'unité',
      seuilAlerte: 8,
      prixAchat: 18500,
      fournisseur: 'Moto-Stores',
      emplacement: 'Zone D - Armoire 1',
      derniereEntree: '08/11/2024',
      derniereSortie: '10/11/2024'
    },
    {
      id: 9,
      nom: 'Rail pour volet roulant',
      reference: 'ACC-RAI-002',
      categorie: 'Accessoires',
      quantite: 24,
      unite: 'barre (3m)',
      seuilAlerte: 15,
      prixAchat: 3200,
      fournisseur: 'Moto-Stores',
      emplacement: 'Zone D - Rack 2',
      derniereEntree: '05/11/2024',
      derniereSortie: '08/11/2024'
    },
    {
      id: 10,
      nom: 'Scie circulaire pour alu',
      reference: 'OUT-SCI-001',
      categorie: 'Outils',
      quantite: 3,
      unite: 'unité',
      seuilAlerte: 1,
      prixAchat: 45000,
      fournisseur: 'Outillage Pro',
      emplacement: 'Atelier - Établi principal',
      derniereEntree: '15/10/2024',
      derniereSortie: '10/11/2024'
    },
    {
      id: 11,
      nom: 'Profilé pour porte d\'entrée',
      reference: 'PRO-POR-003',
      categorie: 'Profilés aluminium',
      quantite: 3,
      unite: 'barre (6m)',
      seuilAlerte: 10,
      prixAchat: 15500,
      fournisseur: 'AlumPro Algérie',
      emplacement: 'Zone A - Rack 2',
      derniereEntree: '30/10/2024',
      derniereSortie: '09/11/2024'
    },
    {
      id: 12,
      nom: 'Vis autoforeuse 5x40',
      reference: 'QUI-VIS-003',
      categorie: 'Quincaillerie',
      quantite: 2450,
      unite: 'unité',
      seuilAlerte: 500,
                    ...
                    <tr key={article.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex gap-2 justify-end">
                          ...
                          <button className="p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100" title="Supprimer">
